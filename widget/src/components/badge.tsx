...
const colors = {
  ...
  base0A: 'bg-custom-base0A/10 text-custom-base0A group-data-hover:bg-custom-base0A/20',
  base0B: 'bg-custom-base0B/10 text-custom-base0B group-data-hover:bg-custom-base0B/20',
}
